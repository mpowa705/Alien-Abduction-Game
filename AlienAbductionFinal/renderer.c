...
Details: All functions by Matt except rendersplash by Brady.
*/
...
/*
Purpose: This function plots the splash screen onto the buffer.
Details: This function sets the splash screen, and then prints the letters for
"1 Player Game", "2 Player Game", and "Abandon Ship!"
Input: Takes in the model.
*/
